...
public static partial class XLExtensions
{
	extension(IXLCell cell)
	{
		...
		public IXLRange SetDocumentTitle(int columns, double fontSize, string title, params IEnumerable<string> subtitles)
		{
			int grow = columns - 1;
			var initial = cell;
		...
		/// <param name="subtitles">Optional subtitles.</param>
		/// <returns>Title and subtitles range.</returns>
		public IXLRange SetDocumentTitle(int columns, string title, params IEnumerable<string> subtitles)
		...
		public IXLCell SetRowGap(int height = 24)
		{
